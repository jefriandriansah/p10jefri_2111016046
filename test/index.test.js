...
describe('Product API Testing', () => {
  ...
  test('should return product data with id 1', async () => {
    ...
    // console.log('ini data',productData);
...
describe('Product Utility Testing', () => {
  ...
  test('convertToRupiah should convert the price correctly', () => {
    ...
    expect(convertedPrice).toMatch(/Rp\s*15\.436\.000,00/);
  });
  ...
  test('setProductsCards should have correct keys', () => {
    ...
    expect(productsCards[0]).toHaveProperty('price');
    expect(productsCards[0]).toHaveProperty('after_discount');
    expect(productsCards[0]).toHaveProperty('image');
  });
